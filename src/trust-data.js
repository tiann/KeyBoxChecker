export const TRUST_DATA = {
  ...
  "roots": [
    {
      "id": "google",
      "label": "Google hardware attestation root public key (legacy/current RSA)",
    ...
    {
      "id": "google_p384_2026",
      "label": "Google hardware attestation root certificate (ECDSA P-384, 2026)",
      "kind": "google_hardware",
      "level": "trusted",
    ...
    {
      "id": "aosp_ec",
      "label": "AOSP software attestation root certificate (EC)",
      "kind": "aosp_software",
      "level": "recognized",
    ...
    {
      "id": "aosp_rsa",
      "label": "AOSP software attestation root certificate (RSA)",
      "kind": "aosp_software",
      "level": "recognized",
    ...
    {
      "id": "knox",
      "label": "Samsung Knox attestation root certificate",
      "kind": "samsung_knox",
      "level": "trusted",
